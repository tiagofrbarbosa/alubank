...
import 'package:alubank/components/color_dot.dat.dart';
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: LinearProgressIndicator(value: 0.3, minHeight: 8.0),
        ),
        Padding(
        ...
        Text(
          'Este mês você gastou \$1500.00 com jogos. Tente abaixar esse custo!',
        ),
        TextButton(
            onPressed: () {},
